/**
 * 광역 → 시/군/구 (사람인 등 채용 플랫폼과 비슷한 전국 단위)
 * 구 선택 UI에서 "전체"는 별도로 앞에 붙입니다.
 */
export const REGION_TREE: Record<string, string[]> = {
  서울: [
    '강남구',
    '강동구',
    '강북구',
...
export const REGION_CITIES = Object.keys(REGION_TREE)
